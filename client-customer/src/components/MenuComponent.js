    ...
    return (
      <div className="border-bottom">
        ...
        <div className="float-right">
          ...
          <input type="search" placeholder="Vui lòng nhập tên sản phẩm" className="keyword" value={this.state.txtKeyword} onChange={(e) => { this.setState({ txtKeyword: e.target.value }) }} />
